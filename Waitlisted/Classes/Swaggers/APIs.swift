...
public class WaitlistedAPI {
    public static var basePath = "https://www.waitlisted.co/api/v2"
...
public class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String:AnyObject]?, isBody: Bool) {
        ...
        addHeaders(WaitlistedAPI.customHeaders)
    }
    ...
    public func addCredential() -> Self {
        self.credential = WaitlistedAPI.credential
        return self
    }
}
